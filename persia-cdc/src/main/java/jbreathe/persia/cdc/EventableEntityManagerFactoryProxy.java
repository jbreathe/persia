...
public final class EventableEntityManagerFactoryProxy implements EntityManagerFactory {
    private final EntityManagerFactory delegate;
    private final List<Supplier<PersistenceEventListener>> listenerInitializers;

    EventableEntityManagerFactoryProxy(EntityManagerFactory delegate,
    ...
    private EntityManager createProxy(EntityManager entityManager) {
        ...
        return new EventableEntityManagerProxy(entityManager, eventListeners);
    }
